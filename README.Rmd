...
The output is an interactive HTML plot that supports zooming and dragging for detailed exploration. In the graph, arrow colors indicate the type of interaction: orange represents positive interactions, and blue represents negative interactions. Nodes represent species, with keystone species—those involved in multiple pairwise interactions—highlighted in yellow.
