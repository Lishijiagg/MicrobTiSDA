...
#'   \item{metadata}{The input metadata, possibly augmented with a combined grouping variable if multiple `Group_var`s were provided.}
#' }
#' @export
#' @author Shijia Li
#'
...
#'
#' @return An object of class `"Design"`, which contains:
