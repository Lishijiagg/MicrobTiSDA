...
oslo_interact_vis = Interact.vis(Interact_data = oslo_data_interact,
                                 ...
                                 label_distance = 0.35,
                                 label_font_size = 3)
# visualise the species interaction results
...
And we can determine the OTU clusters according to the output results above using \code{Data.cluster.cut} by setting the cutting distance equals to 0.2.
