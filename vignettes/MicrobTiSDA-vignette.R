...
## -----------------------------------------------------------------------------
#  oslo_clust_results = Data.cluster.cut(cluster_outputs = oslo_model_clust,cut_height = 0.15,font_size = 2)
...
## -----------------------------------------------------------------------------
#  preterm_rf_vis = Classify.vis(classified_results = selected_biomarkers,dist_method = 'bray')
...
## -----------------------------------------------------------------------------
#  preterm_clust_results = Data.cluster.cut(cluster_outputs = preterm_clust,cut_height = 0.2,font_size = 3.5)
